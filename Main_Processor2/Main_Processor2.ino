...
{
    int duration = 600;
    tone(Buzzer,783.99,duration/2);
    delay(duration/1.9);
    tone(Buzzer,739.99,duration/2);
    delay(duration/1.9);
    tone(Buzzer,783.99,duration*1.75);
    delay(duration*1.76);
    delay(50);
    tone(Buzzer,783.99,duration/2);
    delay(duration/1.9);
    ...
    delay(duration*1.76);
    delay(50);
    tone(Buzzer,392,duration/3);
    delay(duration/3.1);
    tone(Buzzer,783.99,duration/2);
    delay(duration/2.1);
    tone(Buzzer,739.99,duration/2);
    delay(duration/2.1);
    tone(Buzzer,659.26,duration);
    delay(duration+duration*0.01);
    tone(Buzzer,587.33,duration/3);
    delay(duration/2.8);
    tone(Buzzer,587.33,duration*2);
    delay(duration*2);
    lcdclear();
}
...
static void MPS()
{
  ...
  double P = ((29.5/50.0)*(VR-22.6))-59.51;
  MPS_PRES = String(P,2);
  MAX();
}
